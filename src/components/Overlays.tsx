...
export function FloatingCTA() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-7 right-7 z-[115] flex items-center gap-3 rounded-full border border-ink/10 bg-bone/90 py-3 pl-5 pr-3 shadow-[0_10px_40px_rgb(34_29_23/0.14)] backdrop-blur-lg transition-all duration-700 hover:bg-gold ${
        show ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-6 opacity-0"
      }`}
    >
      <span className="text-lg font-medium uppercase tracking-[0.26em] text-ink">WhatsApp</span>
